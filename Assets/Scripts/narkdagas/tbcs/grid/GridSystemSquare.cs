...
namespace narkdagas.tbcs.grid {
    public class GridSystemSquare<TGridObject> where TGridObject : class {
        ...
        public GridSystemSquare(int width, int length, float cellSize, Func<GridSystemSquare<TGridObject>, GridPosition, TGridObject> createGridObjectFunction, bool drawGrid = false, Transform debugPrefab = null) {
