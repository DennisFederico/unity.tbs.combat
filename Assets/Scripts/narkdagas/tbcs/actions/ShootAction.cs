            ...
            for (int floor = -maxShootDistance; floor <= maxShootDistance; floor++) {
                for (int x = -maxShootDistance; x <= maxShootDistance; x++) {
                    for (int z = -maxShootDistance; z <= maxShootDistance; z++) {
                        var targetPosition = new GridPosition(x, z, floor);
                        GridPosition gridPositionCandidate = targetPosition + gridPosition;
                        if (LevelGrid.Instance.IsValidGridPosition(gridPositionCandidate) &&
                            IsInShootingDistance(targetPosition, maxShootDistance) &&
